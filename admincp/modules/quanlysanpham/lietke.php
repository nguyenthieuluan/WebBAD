...
<?php
  $sosp = 4;
	...
	if($trang =='' || $trang =='1'){
		...
		$trang1=($trang*$sosp)-$sosp;
	}
	$sql_lietkesp="select * from sanpham,hieusp,loaisp where loaisp.idloaisp=sanpham.loaisp and hieusp.idhieusp=sanpham.nhasx order by sanpham.idsanpham desc limit $trang1,".$sosp;
